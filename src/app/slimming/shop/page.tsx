  ...
  return (
    <div className="pt-20 min-h-screen bg-white">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #FFF0F3 0%, #FFB6C1 60%, #FFE4EC 100%)",
        }}
      >
        <p className="font-mono text-xs tracking-widest text-pink-600 uppercase mb-2">
          Craig Slimming
        </p>
        <h1 className="font-display text-4xl md:text-5xl font-bold text-pink-900">
          Slimming Shop
        </h1>
        <p className="font-sans text-pink-700/60 mt-3 text-sm">
